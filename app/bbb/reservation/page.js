      ...
      <footer className="bg-slate-50 dark:bg-slate-950 w-full py-16 border-t border-surface-container-high">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 px-8 max-w-7xl mx-auto font-body">
          ...
          <div className="flex flex-col gap-3">
            ...
            <Link href="/bbb/services"><span className="text-slate-600 dark:text-slate-400 hover:text-teal-500 transition-colors cursor-pointer">딥 클리닝</span></Link>
            <Link href="/bbb/services"><span className="text-slate-600 dark:text-slate-400 hover:text-teal-500 transition-colors cursor-pointer">입주/이사 청소</span></Link>
            <Link href="/bbb/services"><span className="text-slate-600 dark:text-slate-400 hover:text-teal-500 transition-colors cursor-pointer">특수 서비스</span></Link>
          </div>
          <div className="flex flex-col gap-3">
