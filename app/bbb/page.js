            ...
            {serviceMode === 'residential' ? (
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <div className="md:col-span-2 bg-surface-container-lowest p-8 rounded-3xl shadow-sm flex flex-col justify-between group hover:shadow-md transition-all">
                  ...
                  <Link href="/bbb/reservation" className="w-full">
                ...
                <div className="bg-surface-container-lowest p-8 rounded-3xl shadow-sm flex flex-col hover:shadow-md transition-all">
                  ...
                  <Link href="/bbb/reservation" className="w-full mt-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 px-8 max-w-7xl mx-auto">
          ...
          <div className="space-y-4">
            ...
            <nav className="flex flex-col gap-2">
              <Link href="/bbb/services"><span className="text-slate-600 hover:text-teal-500 transition-colors cursor-pointer">딥 클리닝</span></Link>
              <Link href="/bbb/services"><span className="text-slate-600 hover:text-teal-500 transition-colors cursor-pointer">이사 / 입주 청소</span></Link>
              <Link href="/bbb/services"><span className="text-slate-600 hover:text-teal-500 transition-colors cursor-pointer">특수 케어 서비스</span></Link>
            </nav>
          </div>
          <div className="space-y-4">
