 ...
 * Moved from page.js to differentiate between multiple page.js files.
 */
        ...
        <div className="max-w-2xl mx-auto space-y-5">
          ...
          {activeSession && (
            <div className="bg-blue-50 border border-blue-100 rounded-2xl p-5 flex items-center gap-4">
              ...
              <Link href="/naekko/profile/lockers" className="flex-shrink-0 text-blue-500 text-xs font-bold flex items-center gap-1 hover:text-blue-700 transition-colors">
          ...
          <div className="space-y-3">
            <Link href="/naekko/profile/lockers">
              <MenuButton
            ...
            <Link href="/naekko/profile/notifications">
              <MenuButton
            ...
            <Link href="/naekko/profile/settings">
              <MenuButton
