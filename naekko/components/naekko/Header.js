        ...
        <div className="container mx-auto px-6 h-16 flex items-center justify-between">
          <div className="flex items-center gap-8">
            ...
            <nav className="hidden md:flex items-center gap-6">
              <Link href="/membership" className="text-[13px] font-black text-blue-600 hover:text-blue-700 transition-colors uppercase tracking-widest bg-blue-50 px-3 py-1.5 rounded-full">멤버십 구독</Link>
              ...
              <Link href="/reviews" className="text-sm font-medium text-[#1D1D1F] hover:text-brand-blue transition-colors">이용 후기</Link>
              <Link href="/faq" className="text-sm font-medium text-[#1D1D1F] hover:text-brand-blue transition-colors">자주 묻는 질문</Link>
            </nav>
          </div>
            {/* Desktop Buttons */}
        ...
        <AnimatePresence>
          {isMobileMenuOpen && (
            <>
              ...
              >
                <Link href="/membership" onClick={() => setIsMobileMenuOpen(false)} className="block text-sm font-black text-blue-600 py-2">멤버십 구독 안내</Link>
                ...
                <Link href="/reviews" onClick={() => setIsMobileMenuOpen(false)} className="block text-sm font-medium py-2">이용 후기</Link>
                <Link href="/faq" onClick={() => setIsMobileMenuOpen(false)} className="block text-sm font-medium py-2">자주 묻는 질문</Link>
